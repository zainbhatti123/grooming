            ...
            <MDBCol col="12">
                ...
                <div class="p-5 pt-3">
                    <div class="p-5 rounded-5 bg-light-grey">
                        ...
                        <div
                            class="d-flex align-items-center justify-content-between py-4 px-3 border-bottom"
                        >
                            <span class="fs-custom text-orange"
                                >Categories</span
                            >
                        ...
                        <div v-if="!loading">
                            <div v-if="categories.length > 0">
                                ...
                                >
                                    <span
                                        class="fs-custom fw-bold text-capitalize"
                    ...
                    >
                      ...
                      >
                        ...
                        />
                            ...
                            <div
                                class="text-center fs-5 fw-500 mt-4 text-orange"
                                v-else
                            >
                                No Categories Found
                            </div>
    ...
    >
        ...
        <MDBModalBody class="p-5 pt-3">
            <div class="custom-height">
                ...
                />
                <span
                    v-if="errors && errors.category_ids"
                    class="text-danger small"
                    >{{ errors.category_ids[0] }}</span
                >
            </div>

      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="{{url('admin/users/provider')}}">Service Providers</a>
            <a class="collapse-item" href="{{url('admin/users/client')}}">Clients/Customers</a>
            <a class="collapse-item" href="{{url('admin/users/admin')}}">Admin</a>
          </div>
        </div>
      </li>
